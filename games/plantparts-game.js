/* ===== Білім Аралы — игра "Части растения" (v2 — режим освоения) =====
   ...
   среди 4. Частей всего 6 — они не заканчиваются, а случайно
   ...
   Использование: initPlantPartsGame('game-root') — plantparts.html не трогать.
*/
function initPlantPartsGame(containerId){
  ...
  function renderFinish(){
    recordGameResult('plantparts', STREAK_NEEDED, STREAK_NEEDED);
    var m = msgs();
    root.innerHTML =
