/* ===== Білім Аралы — игра "Флаг Казахстана" =====
   ...
   Показываем флаг (настоящий флаг-эмодзи), ребёнок определяет —
   это флаг Казахстана, или другой страны. 11 стран: Казахстан +
   соседи (Узбекистан, Кыргызстан) + крупные мировые державы
   (Россия, США, Китай, Франция, Турция, Великобритания, Япония,
   Индия) — для разнообразия при повторных кругах.
...
function initFlagGame(containerId){
  ...
  function renderFinish(){
    recordGameResult('flag', score, TOTAL);
    var m = msgs();
    root.innerHTML =
