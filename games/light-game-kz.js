/* ===== Білім Аралы — игра "Свет: природный или сделанный?" =====
   Естествознание, 1 класс, по программе (приложение 28, цель 1.5.2.2):
   "различать естественные и искусственные источники света".
   Сессия = ровно один проход по всем источникам (без повторов).
   Использование: initLightGame('game-root') после загрузки DOM.
*/
function initLightGame(containerId){
  ...
  function renderFinish(){
    recordGameResult('light_kz', score, TOTAL);
    var m = msgs();
    root.innerHTML =
