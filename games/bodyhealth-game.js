/* ===== Білім Аралы — игра "Тело и здоровье" =====
   ...
   Верно/неверно об утверждениях про тело и здоровье. 12 заранее
   составленных утверждений (6 верных + 6 неверных), показываются
   дважды в перемешанном порядке — 24 вопроса.
   Использование: initBodyHealthGame('game-root') после загрузки DOM.
*/
function initBodyHealthGame(containerId){
  var root = document.getElementById(containerId);
  if(!root) return;

  var STATEMENTS = [
    { key: 'body_st_1', answer: true },
    { key: 'body_st_2', answer: true },
    { key: 'body_st_3', answer: true },
    { key: 'body_st_4', answer: true },
    { key: 'body_st_5', answer: true },
    { key: 'body_st_6', answer: true },
    { key: 'body_st_7', answer: false },
    { key: 'body_st_8', answer: false },
    { key: 'body_st_9', answer: false },
    { key: 'body_st_10', answer: false },
    { key: 'body_st_11', answer: false },
    { key: 'body_st_12', answer: false }
  ];
  ...
  function renderFinish(){
    recordGameResult('bodyhealth', score, TOTAL);
    var m = msgs();
    root.innerHTML =
