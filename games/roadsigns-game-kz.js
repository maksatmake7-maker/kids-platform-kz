/* ===== Білім Аралы — игра "Дорожные знаки" =====
   ...
   8 знаков: светофор, пешеходный переход, СТОП, предупреждение,
   дорожные работы, движение запрещено, остановка автобуса,
   парковка — расширено с 5 для разнообразия при повторных кругах.
...
function initRoadSignsGame(containerId){
  ...
  function renderFinish(){
    recordGameResult('roadsigns_kz', score, TOTAL);
    var m = msgs();
    root.innerHTML =
