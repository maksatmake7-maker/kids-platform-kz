/* ===== Білім Аралы — игра "Что нужно растению?" =====
   ...
   растению для жизни или нет.
   Сессия = ровно один проход по всем предметам (без повторов).
   Использование: initPlantNeedsGame('game-root') после загрузки DOM.
*/
function initPlantNeedsGame(containerId){
  ...
  function renderFinish(){
    recordGameResult('plantneeds_kz', score, TOTAL);
    var m = msgs();
    root.innerHTML =
